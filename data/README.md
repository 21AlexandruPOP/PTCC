...
* **Număr de caracteristici (features):** [Ex: 8]
...
|-------------------|---------|-------------|---------------|--------------------|
| distance_km | numeric | KM | [distanta traseului propus] | 10-700 |
| city_share_pct | numeric | – | [procentul de distanta parcursa urban] | 5-100 |
| avg_speed_city | numeric | km/h | [media vitezei in zona urbana] | 18-35 |
| ac_on | boolean | - | [daca este sau nu AC ON] | 0-1 |
| persons_in_car | numeric | - | [numarul persoanelor prezente in masina] | 1-5 |
| tire_pressure_bar | numeric | bar | [presiune pneuri] | 1.8-2.25 |
| outside_temp_c | numeric | C | [temperatura ambianta] | -10-30 |
| fuel_used_l | numeric | l | [rezultatul: litrii consumati pe distanta respectiva] | - |
| ... | ... | ... | ... | ... |
