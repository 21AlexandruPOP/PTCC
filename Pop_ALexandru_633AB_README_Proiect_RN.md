...
| **Link Repository GitHub** | [https://github.com/21AlexandruPOP/PTCC] |
| **Acces Repository** | [Public / Privat cu acces cadre didactice RN] |
| **Stack Tehnologic** | [Python] |
| **Domeniul Industrial de Interes (DII)** | [Automotive / Industrial engineering] |
...
[Ca inginer industrial, scopul meu este sa optimizez tot ce se poate optimiza pentru o companie, lucru imposibil fara date exacte. In cazu acesta, urmaresc sa optimizez partea de cheltuieli pe transport (fie de persoane, fie de produse), "compania" dsipunand de o flota de Mazda 3 BK14, motorizare 1.6 benzina. Prin utilizarea aplicatiei, pot sa prezic cheltuieli in fucntie de stilul de condus al diferitilor angajati din companie, factorilor externi, cat si sa gasesc rute mai eficiente.]

### 2.2 Beneficii Măsurabile Urmărite

*[Listați 3-5 beneficii concrete cu metrici țintă]*

1. [Prezicerea cheltuielilor/drum]
2. [Colectarea de date despre tipul de soferi din cadrul companiei]
3. [Optimizarea traseelor pentru reducerea custurilor de carburant]
4. [...]
5. [...]
...
| **Număr total observații finale (N)** | [ex: 10,000] |
...
[Pentru generarea datelor am ales sa folosesc parametrii oficiali transmisi de Mazda in legatura cu consumul urban/extra-urban, cat si observatii de pe diverse forumuri si personale in legatura cu influenta celorlati factori asupra consumului. Intrucat aceeasi masina poate avea cosnum total diferit pe acelasi traseu in functie de restul parametrilor, consider ca pentru o analiza detaliata este necesara utilizarea acestora la input.]
...
- [Shuffle si Reset Index]
- [Conversie a tipului de date]
- [Encoding Binat]
- [old-Out splitting]
...
|-------|------------|---------------------------|-----------------|
| **Data Logging / Acquisition** | [Python] | [ex: Generare date simulate cu zgomot] | `src/data_acquisition/` |
| **Neural Network** | [Keras/PyTorch/LabVIEW] | [ex: Clasificare multi-clasă cu CNN] | `src/neural_network/` |
| **Web Service / UI** | [Streamlit] | [ex: Interfață setare date de intrare + predicție + grafic cu preturile din ultimele 30 de zile] | `src/app/` |
...
|-------|-----------|------------------|-----------------|
| `IDLE` | [Așteptare input utilizator] | [Start aplicație] | [Apasare buton estimeaza consumul] |
| `ACQUIRE_DATA` | [Citire date introduse de utilizator si preluare pret combustibil] | [Declansare eveniment] | [Date preluate din dataframe] |
| `PREPROCESS` | [Validarea datelor] | [Date disponibile in memorie] | [Input validat si formatat] |
| `INFERENCE` | [Executia modelului MLP] | [Input pregatit pentru retea] | [Predicție generată] |
| `DECISION` | [Calculul metricilor secoundare (pret/trip)] | [predictie generata] | [Rezultate finale calculate] |
| `OUTPUT/ALERT` | [Afișare rezultat] | [Calcule finalizate] | [afisare rezultate in ui] |
| `ERROR` | [Gestionare erori] | [Model lipsa/Imposibilitate de preluare date live] | [mesaj st.error afiasat] |

**Justificare alegere arhitectură State Machine:**

*[1 paragraf: De ce această structură pentru problema voastră specifică?]*

[Am ales structura de State Machine pentru a controla exact fluxul datelor si pentru a evita crash-urile aplicatiei. Aceasta arhitectura imi permite sa izolez clar etapa de "pregatire" a datelor de cea de "calcul" (inferenta). Cel mai mare avantaj este gestionarea erorilor: daca scraping-ul de preturi Peco pica in starea ACQUIRE_DATA, sistemul stie sa treaca imediat pe fallback-ul local (CSV), fara sa opreasca executia modelului MLP. Practic, am ales acest model pentru a avea un cod modular, unde pot valida input-urile din slidere inainte ca ele sa ajunga la reteaua neuronala, asigurand stabilitatea intregului pipeline.]
...
Input (8 parametri: distanta, %oras, viteze, AC, pasageri, presiune, temp) 
  → Dense(64,ReLU)
  → Dense(32, ReLU)
...
[Am ales aceasta arhitectura MLP (64x32) deoarece ofera un echilibru optim intre capacitatea de invatare si viteza de calcul pentru cele 8 variabile de intrare. Am considerat initial o varianta mai simpla (32x16), dar am respins-o pentru ca dadea subestimari ale consumului (underfitting), in timp ce variantele mai complexe cu mai multe straturi au fost respinse pentru a evita memorarea datelor (overfitting) si cresterea inutila a latentei.]
...
| Batch Size | [32] | [Compromis memorie/stabilitate pentru N=10.000 samples] |
| Epochs | [max 2000] | [Early stopping după 10 epoci fără îmbunătățire] |
| Optimizer | [Adam] | [Adaptive LR, potrivit pentru date de tip numerice] |
| Loss Function | [MSE] | [Functia standard pentru probleme de regresie, penalizand mai sever erorile mari de predictie a consumului.] |
| Regularizare | [Early Stopping] | [Prevenire overfitting potential datorat stratului de 64 neuroni] |
| Early Stopping | [n_iter_no_change = 10] | [Permite modelului sa mai incerce imbunatatiri timp de 10 epoci inainte de a confirma ca a ajuns la valoarea minima a erorii.] |

### 5.3 Experimente de Optimizare (minim 4 experimente)

| Exp# | Modificare față de Baseline | Accuracy | F1-Score | Timp Antrenare | Observații |
|------|----------------------------|----------|----------|----------------|------------|
| **Baseline** | Configuratia Etapa 5 (32x16, no early stopping) | [98.7%] | [1.00] | [~1 min] | Eroare mica, dar risc mare de overfitting pe date noi. |
| Exp 1 | [Activare Early Stopping (val_fraction=0.1)] | [98.2] | [1.00] | [<1 min] | [Modelul a devenit mai "onest"; eroarea a crescut pentru ca nu mai "toceste" datele.] |
| Exp 2 | [Crestere arhitectura (64x32 neuroni)] | [98.61%] | [1.00] | [~2 min] | [BEST - Modelul are destula capacitate sa invete corelatiile fara sa faca overfitting.] |
| Exp 3 | [n_iter_no_change 5 -> 15] | [X.XX%] | [X.XX] | [X min] | [ex: Reduce overfitting din Exp 2] |
...
[Am ales configuratia din Exp 2 deoarece ofera cel mai bun echilibru intre precizie (MAE 0.51) si stabilitate. Desi timpul de antrenare a crescut usor fata de baseline, am acceptat acest compromis pentru a avea o arhitectura (64x32) destul de complexa sa inteleaga datele, dar controlata de Early Stopping ca sa nu "invete pe de rost" setul de training. Am refuzat modelele mai mari pentru ca mareau latenta fara sa aduca beneficii reale la eroare, preferand o solutie rapida si eficienta pentru inferenta in timp real.]
...
[La un MAE de 0.51 litri, aplicatia ofera o precizie ridicata pentru planificarea bugetului de transport. Tradus in impact real, la o calatorie de 500 km unde modelul estimeaza un consum de 40L, eroarea maxima asteptata este de aproximativ 2.5 litri (0.51 L/100km x 5). La un pret mediu de 7.5 RON/litru, acest lucru inseamna o variatie de doar 18.75 RON fata de realitate. Pentru un utilizator individual, eroarea este neglijabila, insa pentru o flota logistica ce parcurge 10.000 km lunar, precizia modelului permite o monitorizare a costurilor cu o marja de eroare de sub 380 RON, prevenind pierderi financiare majore cauzate de estimari gresite sau fluctuatii neprevazute ale pretului la pompa.]

**Pragul de acceptabilitate pentru domeniu:** [< 0.70 L/100km]  
**Status:** [Atins]  
**Plan de îmbunătățire (dacă neatins):** [a fost atins
---
...
**Latență măsurată end-to-end:** [0.99] ms  
**Data și ora demonstrației:** [11.02.2026, 18:28]
